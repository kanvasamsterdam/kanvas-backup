	...
	<div class="form_inners">
		<div class="form_datasheet">
			<h2 class="datasheet_inleiding">
				Inschrijven voor KOPENHAGEN.
			</h2>
			<p class="datasheet_inleiding">
				Je kunt je hier inschrijven voor de KANVAS-reis naar Kopenhagen, je ontvangt van ons een e-mail als we je inschrijving hebben ontvangen.
