...
<title>KANVAS - Inschrijving Caldic Collectie</title>
...
<div class="layout">
	<div class="head"></div>
	<h1 class="form_title">Inschrijven Caldic Collectie</h1>
	<div class="form_inners">
		<div class="form_datasheet">
			<h2 class="datasheet_inleiding">
				Leuk dat je mee wil met deze acitiviteit!
			</h2>
			<p class="datasheet_inleiding">
				Vul het onderstaande formulier zorgvuldig in, deze persoonlijke informatie hebben wij van je nodig omdat wij ons van te voren aan moeten melden bij de Collectie.
 			
			</p>
			<div style="height:10px;"></div>
			<form name="lid_worden" action="http://www.kanvasamsterdam.nl/assets/forms/inschrijving_caldic.php" method="post">
