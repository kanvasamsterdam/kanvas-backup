...
$bijdrage = htmlspecialchars($_POST['bijdrage']);
...
email-adres:<br><a href="mailto:'.$emailadres.'">'.$emailadres.'</a><br><br>
bijdrage:<br>'.$bijdrage.'<br><br>
</p>
</body>
</html>
...
$subject = "Een nieuwe Vriend voor Kanvas : ".$naam;
$headers = $from;
	...
	<div class="form_inners">
		<div class="form_datasheet">
			<h2 class="datasheet_inleiding">
				Bedankt voor het aangaan van deze Vriendschap !
			</h2>
			<p class="datasheet_inleiding" style="color:#000000;border-bottom:0px;"><br>
				Je zult zo snel mogelijk een e-mail ontvangen met alle details over betaling.<br><br>
