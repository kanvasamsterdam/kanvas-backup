...
<html>
<body>
<h4>Een nieuwe inschrijving voor Hamburg</h4>
<p>
-----------------------------------------<br>
naam:<br>'.$naam.'<br><br>
...
$inschrijvingen_email = "info@kanvasamsterdam.nl";
$checkaccount = "mail.jeroenderooij@gmail.com";

$from = "From:".$emailadres."\n";


$subject = "Een nieuwe inschrijving voor Hamburg : ".$naam;
$headers = $from;
...
<div class="layout">
	<div class="head"></div>
	<h1 class="form_title">Hamburg</h1>
