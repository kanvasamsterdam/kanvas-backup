...
<title>KANVAS - Vriendschaps formulier</title>
...
<script language="javascript">
	...
	function send(){
		...
		document.vriend_worden.submit();
		
	}
	
	function cleardata(idname){
		var crt = document.vriend_worden.adres.value;
		if(crt == "straatnaam, huisnr."){
			document.vriend_worden.adres.value = "";
		}else{
			document.vriend_worden.adres.value = crt;
		}
	}
...
<div class="layout">
	<div class="head"></div>
	<h1 class="form_title">Vriendschaps formulier</h1>
	<div class="form_inners">
		<div class="form_datasheet">
			<h2 class="datasheet_inleiding">
				Leuk dat je Vriend wil worden van Kanvas!
			</h2>
			...
			<form name="vriend_worden" action="http://www.kanvasamsterdam.nl/assets/forms/inschrijving_vriendschap.php" method="post">
			...
			<table class="data nwr" cellpadding="0" cellspacing="0">
			<tr>
				<td class="name">hoogte bijdrage</td>
				<td class="input">
					<input type="text" name="bijdrage" class="b"/>
				</td>
			</tr>
			</table>
