	...
	<div class="form_inners">
		<div class="form_datasheet">
			...
			<p class="datasheet_inleiding">
				Hier kun je alle boeken die je in je eerste jaar nodig hebt bestellen tegen een gereduceerde prijs. Voor tweedejaars hebben wij het boek 'Wetenschapsfilosofie voor de Geesteswetenschappen'. Wij leggen de boeken voor je klaar en je kunt het op de volgende dagen ophalen:
				<br><br>
